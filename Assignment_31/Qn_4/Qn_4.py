...
def DirectoryCopy(SourceDir, DestDir, Extension):
    Border = "-"*50
    ...
    fobj.write("This script Copies all files with the specified extension from first directory into second directory\n")
    fobj.write(Border+"\n")
